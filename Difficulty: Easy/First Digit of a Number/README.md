<h2><a href="https://www.geeksforgeeks.org/problems/first-digit-of-a-number/1?page=1&category=Java-Collections&difficulty=Basic,Easy,Medium&sortBy=submissions">First Digit of a Number</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a number <strong>n, </strong>find the first digit of the number.</span></p>
